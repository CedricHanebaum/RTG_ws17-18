...
void Assignment08::update(float elapsedSeconds)
{
...
void Assignment08::render(float elapsedSeconds)
{
...
void Assignment08::renderShadowPass()
{
...
void Assignment08::renderDepthPrePass()
{
    /// Task 1.b
    ///
    /// Your job is to:
...
void Assignment08::renderOpaquePass()
{
    ...
    if(!mPassOpaque) return;

    // bind and clear g buffer
    auto buffer = mFramebufferGBuffer->bind();
...
void Assignment08::renderLightPass()
{
...
void Assignment08::renderTransparentPass()
{
    // debug: wireframe rendering
...
void Assignment08::renderTransparentResolve()
{
...
void Assignment08::renderOutputStage()
{
    GLOW_SCOPED(disable, GL_DEPTH_TEST);
    GLOW_SCOPED(disable, GL_CULL_FACE);
...
void Assignment08::renderScene(camera::CameraBase* cam, RenderPass pass)
{
...
void Assignment08::setUpShader(glow::Program* program, camera::CameraBase* cam, RenderPass pass)
{
    auto shader = program->use();
...
void Assignment08::setUpLightShader(glow::Program* program, glow::camera::CameraBase* cam)
{
    auto shader = program->use();
...
void Assignment08::buildLineMesh()
{
...
void Assignment08::drawLine(glm::vec3 from, glm::vec3 to, glm::vec3 color, RenderPass pass)
{
    if (pass != RenderPass::Transparent)
    {
...
void Assignment08::drawAABB(glm::vec3 min, glm::vec3 max, glm::vec3 color, RenderPass pass)
{
    if (pass != RenderPass::Transparent)
    {
        glow::error() << "not implemented.";
...
void Assignment08::spawnLightSource(glm::vec3 const& origin)
{
    LightSource ls;
    ls.position = origin;
...
void Assignment08::updateLightSources(float elapsedSeconds)
{
...
void Assignment08::getMouseRay(glm::vec3& pos, glm::vec3& dir) const
{
...
void Assignment08::updateViewRay()
{
    // calculate mouse ray
    glm::vec3 pos, dir;
    getMouseRay(pos, dir);
...
void Assignment08::createTerrainShader(std::string const& name)
{
...
void Assignment08::updateShadowMapTexture()
{
...
bool Assignment08::onMouseButton(double x, double y, int button, int action, int mods, int clickCount)
{
...
bool Assignment08::onMousePosition(double x, double y)
{
...
bool Assignment08::onKey(int key, int scancode, int action, int mods)
{
...
void Assignment08::onResize(int w, int h)
{
...
void Assignment08::setUpTweakBar()
{
    ...
    TwAddVarRW(tweakbar(), "Output", TwDefineEnum("DebugOutput", targetsEV, 16), &mDebugOutput, "group=debug");

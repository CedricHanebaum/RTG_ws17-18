...
SharedTextureCubeMap TextureCubeMap::create(size_t width, size_t height, GLenum internalFormat)
{
...
SharedTextureCubeMap TextureCubeMap::createStorageImmutable(size_t width, size_t height, GLenum internalFormat, int mipmapLevels)
{
    auto tex = std::make_shared<TextureCubeMap>(internalFormat);
...
void TextureCubeMap::BoundTextureCubeMap::makeStorageImmutable(size_t width, size_t height, GLenum internalFormat, int mipmapLevels)
{
    if (!isCurrent())
        return;
...
void TextureCubeMap::BoundTextureCubeMap::resize(size_t width, size_t height)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
void TextureCubeMap::BoundTextureCubeMap::setData(GLenum internalFormat, GLenum target, size_t width, size_t height, GLenum format, GLenum type, const GLvoid *data, int mipmapLevel)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
void TextureCubeMap::BoundTextureCubeMap::setSubData(GLenum target, size_t x, size_t y, size_t width, size_t height, GLenum format, GLenum type, const GLvoid *data, int mipmapLevel)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
#else
    error() << "TextureCubeMap::clear is only supported for OpenGL 4.4+";9
#endif

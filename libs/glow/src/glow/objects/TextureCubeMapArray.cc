...
SharedTextureCubeMapArray TextureCubeMapArray::create(size_t width, size_t height, size_t layers, GLenum internalFormat)
{
...
SharedTextureCubeMapArray TextureCubeMapArray::createStorageImmutable(size_t width, size_t height, size_t layers, GLenum internalFormat, int mipmapLevels)
{
    auto tex = std::make_shared<TextureCubeMapArray>(internalFormat);
...
void TextureCubeMapArray::BoundTextureCubeMapArray::makeStorageImmutable(size_t width, size_t height, size_t layers, GLenum internalFormat, int mipmapLevels)
{
    if (!isCurrent())
        return;
...
void TextureCubeMapArray::BoundTextureCubeMapArray::resize(size_t width, size_t height, size_t layers)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
void TextureCubeMapArray::BoundTextureCubeMapArray::setSubData(GLenum target, size_t x, size_t y, size_t l, size_t width, size_t height, size_t layers, GLenum format, GLenum type, const GLvoid *data, int mipmapLevel)
{
    if (!isCurrent())
        return;
    checkValidGLOW();

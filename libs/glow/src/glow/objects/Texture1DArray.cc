...
SharedTexture1DArray Texture1DArray::create(size_t width, size_t layers, GLenum internalFormat)
{
...
SharedTexture1DArray Texture1DArray::createStorageImmutable(size_t width, size_t layers, GLenum internalFormat, int mipmapLevels)
{
    auto tex = std::make_shared<Texture1DArray>(internalFormat);
...
void Texture1DArray::BoundTexture1DArray::makeStorageImmutable(size_t width, size_t layers, GLenum internalFormat, int mipmapLevels)
{
    if (!isCurrent())
        return;
...
void Texture1DArray::BoundTexture1DArray::resize(size_t width, size_t layers)
{
    if (!isCurrent())
        return;
    checkValidGLOW();
...
void Texture1DArray::BoundTexture1DArray::setSubData(size_t x, size_t l, size_t width, size_t layers, GLenum format, GLenum type, const GLvoid *data, int mipmapLevel)
{
    if (!isCurrent())
        return;
    checkValidGLOW();

...
void Texture3D::BoundTexture3D::setSubData(size_t x, size_t y, size_t z, size_t width, size_t height, size_t depth, GLenum format, GLenum type, const GLvoid *data, int mipmapLevel)
{
    if (!isCurrent())
        return;
    checkValidGLOW();

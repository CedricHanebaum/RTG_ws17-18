...
private:
    ...
    glow::camera::SharedGenericCamera mCam;
    /// Character position
    glm::vec3 mPosition;
    /// Character velocity;
    glm::vec3 mVelocity;
...
public:
    ...
    Character(glow::camera::SharedGenericCamera const& cam) : mCam(cam), mPosition(cam->getPosition()) {}

    void update(World &world, float elapsedSeconds, glm::vec3 const& movement);
